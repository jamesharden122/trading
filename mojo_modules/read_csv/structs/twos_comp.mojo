...
struct Int64TwosComp:
    ...
    fn __init__(inout self, simd_dec_list: List[SIMD[DType.uint8,8]]):
        self.simd_dec_list = simd_dec_list
        
    fn int64_conversion(self) -> Tensor[DType.int64]:
...
struct Int32TwosComp:
    ...
    fn __init__(inout self, simd_dec_list: List[SIMD[DType.uint8,4]]):
        self.simd_dec_list = simd_dec_list
        
    fn int32_conversion(self) -> Tensor[DType.int32]:
        var simd_processed_bits = self.process_simd_list(self.simd_dec_list)
